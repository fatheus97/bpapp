...
public enum EventType {
    BUILDING_KILL, CHAMPION_KILL, CHAMPION_SPECIAL_KILL, ELITE_MONSTER_KILL, GAME_END, ITEM_DESTROYED, ITEM_PURCHASED, ITEM_SOLD, ITEM_UNDO, LEVEL_UP, OBJECTIVE_BOUNTY_PRESTART, PAUSE_END, SKILL_LEVEL_UP, TURRET_PLATE_DESTROYED, WARD_KILL, WARD_PLACED;
    ...
    public String toValue() {
        switch (this) {
            ...
            case OBJECTIVE_BOUNTY_PRESTART: return "OBJECTIVE_BOUNTY_PRESTART";
    ...
    public static EventType forValue(String value) throws IOException {
        ...
        if (value.equals("OBJECTIVE_BOUNTY_PRESTART")) return OBJECTIVE_BOUNTY_PRESTART;
